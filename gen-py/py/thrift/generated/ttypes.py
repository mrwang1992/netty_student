...
class DataException(TException):
    ...
    def __init__(self, message=None, callStrack=None, date=None,):
        self.message = message
        self.callStrack = callStrack
        self.date = date
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.callStrack = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.message is not None:
            ...
            oprot.writeFieldEnd()
        if self.callStrack is not None:
            oprot.writeFieldBegin('callStrack', TType.STRING, 2)
            oprot.writeString(self.callStrack.encode('utf-8') if sys.version_info[0] == 2 else self.callStrack)
            oprot.writeFieldEnd()
...
DataException.thrift_spec = (
    ...
    (2, TType.STRING, 'callStrack', 'UTF8', None, ),  # 2
